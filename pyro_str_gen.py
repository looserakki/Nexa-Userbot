...
async def pyro_str():
    ...
    async with Client(":memory:", api_id, api_hash) as NEXAUB:
        ...
        await session_msg.reply_text("Successfully Generated String Session! Thanks for trying [Nexa Userbot](https://github.com/xhrvan/Nexa-Userbot) \n\n**Join @TGxBOTz**", disable_web_page_preview=True)
