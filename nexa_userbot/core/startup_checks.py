...
Thanks for trying Nexa Userbot. If you found any error, bug or even a Feature Request please report it at **@TGxBOTz**
 ...
 **~ Nexa Userbot Authors**"""
        ...
        print(f"Error \n\n{e} \n\nPlease check all variables and try again! \nReport this with logs at @TGxBOTz if the problem persists!")
        exit()
